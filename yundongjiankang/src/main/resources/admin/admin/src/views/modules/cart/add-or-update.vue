        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='meishi'">
                    <el-form-item class="select" v-if="type!='info'"  label="商品" prop="meishiId">
                        <el-select v-model="ruleForm.meishiId" :disabled="ro.meishiId" filterable placeholder="请选择商品" @change="meishiChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品名称" prop="meishiName">
                        <el-input v-model="meishiForm.meishiName"
                                  placeholder="商品名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品名称" prop="meishiName">
                            <el-input v-model="ruleForm.meishiName"
                                      placeholder="商品名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='meishi' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.meishiPhoto" label="商品照片" prop="meishiPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (meishiForm.meishiPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.meishiPhoto" label="商品照片" prop="meishiPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品类型" prop="meishiValue">
                        <el-input v-model="meishiForm.meishiValue"
                                  placeholder="商品类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品类型" prop="meishiValue">
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="meishiKucunNumber">
                        <el-input v-model="meishiForm.meishiKucunNumber"
                                  placeholder="商品库存" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品库存" prop="meishiKucunNumber">
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="meishiOldMoney">
                        <el-input v-model="meishiForm.meishiOldMoney"
                                  placeholder="商品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品原价" prop="meishiOldMoney">
                ...
                <el-col :span="12"  v-if="sessionTable !='meishi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="meishiClicknum">
                        <el-input v-model="meishiForm.meishiClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="meishiClicknum">
