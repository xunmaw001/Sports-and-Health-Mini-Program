        ...
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品名称" prop="meishiName">
                       <el-input v-model="ruleForm.meishiName"
                                 placeholder="商品名称" clearable  :readonly="ro.meishiName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="商品类型" prop="meishiTypes">
                        <el-select v-model="ruleForm.meishiTypes" :disabled="ro.meishiTypes" placeholder="请选择商品类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="meishiKucunNumber">
                       <el-input v-model="ruleForm.meishiKucunNumber"
                                 placeholder="商品库存" clearable  :readonly="ro.meishiKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="meishiOldMoney">
                       <el-input v-model="ruleForm.meishiOldMoney"
                                 placeholder="商品原价" clearable  :readonly="ro.meishiOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="商品简介" prop="meishiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.meishiContent" label="商品简介" prop="meishiContent">
