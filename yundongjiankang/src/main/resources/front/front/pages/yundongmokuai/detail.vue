...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<!-- 名字-->
						<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>{{detail.yundongmokuaiName}}
						</view>
				</view>
   	 <view style="margin-top: 10rpx;"></view>
					...
					<view class="detail-list-item"
						...
						<view class="lable"
							...
							消耗卡路里：</view>
						<view class="text" :style='{"color":"#E57498","textAlign":"center","fontSize":"24rpx"}'>
							{{detail.yundongmokuaiKaululi}}</view>
					</view>
					<view class="detail-list-item"
						  :style='{"boxShadow":"0 0 4rpx 0 #006633 insta","margin":"0 60rpx 0 60rpx","borderColor":"rgba(218, 218, 218, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"68rpx"}'>
						<view class="lable"
							...
							运动运动类型：</view>
						<view class="text" :style='{"color":"#E57498","textAlign":"center","fontSize":"24rpx"}'>
                            {{detail.yundongmokuaiValue}}</view>
					</view>
			</view>
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.yundongmokuaiContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('yundongmokuai', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.yundongmokuaiPhoto ? this.detail.yundongmokuaiPhoto.split(",") : [];
			},
