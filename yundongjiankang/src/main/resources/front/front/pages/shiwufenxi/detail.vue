...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback"
		...
		<view class="container">
			...
			<!-- 名字-->
						<view :style='{"textAlign":"left","fontSize":"45upx","color":"black"}'>{{detail.shiwufenxiName}}
						</view>
				</view>
   	 <view style="margin-top: 10rpx;"></view>
			...
			<view class="time-content"
				...
				<view class="content" style="line-height: 50upx;letter-spacing: 5upx;"
					...
					<rich-text :nodes="detail.shiwufenxiContent"></rich-text>
				</view>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			// 获取详情
			async init() {
				let res = await this.$api.info('shiwufenxi', this.id);
				this.detail = res.data;
				// 主图
				this.swiperList = this.detail.shiwufenxiPhoto ? this.detail.shiwufenxiPhoto.split(",") : [];
			},
