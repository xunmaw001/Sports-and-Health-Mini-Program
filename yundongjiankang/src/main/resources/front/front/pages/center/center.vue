<template>
    <view class="content">
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
              :style='{"backgroundColor":"#B24592","height":"200rpx"}'>
            ...
            <view class="setting" :style='{"color":"#E57498","fontSize":"40rpx"}'>
        ...
        <view class="list">
              ...
              <view  @tap="onPageTap('../recharge/recharge')"
                     :style='{"backgroundColor":"#E57498","borderColor":"#B24592","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
