...
//                            meishiEntity.setMeishiName(data.get(0));                    //商品名称 要改的
//                            meishiEntity.setMeishiPhoto("");//照片
//                            meishiEntity.setMeishiTypes(Integer.valueOf(data.get(0)));   //商品类型 要改的
//                            meishiEntity.setMeishiKucunNumber(Integer.valueOf(data.get(0)));   //商品库存 要改的
//                            meishiEntity.setMeishiOldMoney(data.get(0));                    //商品原价 要改的
